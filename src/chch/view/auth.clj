(ns chch.view.auth
    (:require [ring.util.response :as response]
              ...
              [chch.util.session :as session]
              [chch.util.flash :as flash]
              [chch.service.db :as db]
              [chch.view.common :refer [wrap-context-root wrap-layout authenticated?]]))
...
(defn- reset-pass-page
  ...
  (wrap-layout
   "Reset password"
   (stencil/render-file
    "chch/view/templates/reset-pass"
    {})))
